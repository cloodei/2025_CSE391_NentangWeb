            ...
            {news.map(todo => (
              ...
              >
                ...
                <div className="flex gap-0.5">
                  <button className="p-1 text-green-600 transition hover:bg-green-100 rounded" onClick={complete}>
                    <Edit size={18} />
                  </button>
                  <button className="p-1 text-red-600 transition hover:bg-red-100 rounded" onClick={destroy}>
                    <Trash size={18} />
                  </button>
                </div>
          ...
          <div className="space-y-2.5">
            {destroyed.map(todo => (
              ...
              >
                ...
                <div className="flex gap-0.5">
                  <button className="p-1 text-blue-600 transition hover:bg-blue-100 rounded" onClick={renew}>
                    <RotateCcw size={18} />
                  </button>
                </div>
